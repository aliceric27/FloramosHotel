<template>
  <div>
    ...
    <div class="flex items-center justify-center">
      <div class="grid w-[80dvw] h-[58dvh] grid-cols-[auto,1fr,auto]">
        <div class="w-full h-full bg-white">
          ...
          <div class="flex justify-between h-full">
            ...
            <div class="flex flex-col justify-around">
              <div>
                <deviceWater :title="'屋頂-水塔蓋'" :isNormal="true" />
              </div>
              <div>
                <deviceWater :title="'屋頂-水塔'" :isNormal="false" />
              </div>
              <div class="relative">
        ...
        <div class="w-full h-full bg-white">
          ...
          <div class="flex justify-between h-full">
            ...
            <div class="flex flex-col justify-around">
              <div>
                <deviceWater :title="'自來水-水箱蓋'" :isNormal="true" />
              </div>
              <div><deviceWater :title="'自來水-水箱'" :isNormal="true" /></div>
              <div class="relative">
