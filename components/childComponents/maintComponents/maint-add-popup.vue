  ...
  <div>
    <div class="main-container" v-if="isPopup">
      ...
      <div class="box">
        ...
        <el-date-picker v-model="datepick" type="date" placeholder="日期選擇" />
      </div>
      <div class="wrapper-3">
        <span class="text-7">保養週期</span>
        <div class="box-2">
          <el-input v-model="customcycle" placeholder="數值" />
        </div>
        <div class="wrapper-4">
      ...
      <div class="section-2">
        ...
        <div class="section-3"><span class="text-b">確認保養</span></div>
      </div>
    </div>
  </div>
</template>
